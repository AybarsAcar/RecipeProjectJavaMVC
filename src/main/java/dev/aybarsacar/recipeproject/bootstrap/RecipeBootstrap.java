package dev.aybarsacar.recipeproject.bootstrap;

import dev.aybarsacar.recipeproject.domain.*;
import dev.aybarsacar.recipeproject.domain.enums.Difficulty;
import dev.aybarsacar.recipeproject.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>
{
  ...
  public void onApplicationEvent(ContextRefreshedEvent event)
  {
    ...
    log.info("Recipes are fed successfully into the database");
  }
